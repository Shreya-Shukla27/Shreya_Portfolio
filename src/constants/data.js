...
export const PROJECTS = {
  grid: [
    ...
    },
    {
      id: 'pastel-diary',
      year: '2026',
      title: 'Pastel Diary — Soft Personal Diary',
      desc: 'A soft, dreamy personal diary with cloud storage, mood tracking, themes, PIN lock, and responsive mobile-first UI.',
      metrics: [
        { val: '5', label: 'Themes' },
        { val: 'Cloud', label: 'Storage' },
        { val: '📊', label: 'Mood Graph' },
      ],
      tags: ['React', 'Express', 'MongoDB', 'Vercel', 'Render'],
      links: [
        { label: 'Live', href: 'https://pastel-diary-roan.vercel.app', type: 'primary' },
        { label: 'GitHub', href: 'https://github.com/Shreya-Shukla27/pastel-diary', type: 'secondary' },
      ],
    },
    {
